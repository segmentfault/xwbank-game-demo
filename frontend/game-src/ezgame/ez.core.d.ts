...
declare namespace ez {
    ...
    */
    ...
    /**
    * 集合数据源
    *	在集合数据源上可以获取数据项添加/删除/修改的通知
    */
    class DataCollection implements IDispose {
        private _items;
        private _observers;
        private remove;
        private static dataChangeNotify;
        constructor(items?: any[]);
        /**
        * 所有的数据项
        * 	只读属性，对数据集进行的直接修改将不会产生通知世界
        */
        get items(): any[];
        /**
        * 获取数据项
    ...
    /**
    * 数据模型对象里可以动态添加/删除/修改属性，
    * 属性的修改可以添加观察者来获得通知，可以添加数据绑定来
    * 同步2个对象间的属性值
    */
    class DataModel implements IDispose {
        ...
        */
        ...
        /**
        * 属性绑定，当DataModel的属性变化时自动将目标对象的属性更新为最新的值，通过转换器可以将值进行相应的修改后在设置到目标对象上
        * @param propName 属性名
...
interface NativeAudioDefine {
    setMusicVolume(track: number, val: number): any;
    setSFXVolume(val: number): any;
    playSFX(name: string): any;
    stopMusic(track: number, fadeOut?: number): any;
    playMusic(track: number, name: string, volume: number, loop: boolean, fadeIn: number): any;
}
/**@ignore */
...
declare namespace ez {
    ...
    */
    ...
    namespace internal {
        function createWGLRenderContext(wgl: WebGLRenderingContext): void;
    }
}
declare namespace ez {
    /**
    ...
    */
    ...
    abstract class Sprite implements IDispose {
        ...
        protected _setDirty(needSort?: boolean): void;
        ...
        */
        ...
        /**
        * shader特效(仅WebGL模式下支持)，默认为null使用默认效果
        */
        get effect(): string;
        ...
        */
        ...
        /**
        * 设置排序值，对象显示顺序自动按照zIndex顺序排序，zIndex大的在上面
        */
        get zIndex(): number;
...
declare namespace ez {
    ...
    class LabelSprite extends Sprite {
        ...
        * 渐变填充
        */
        get gradient(): GradientFill;
        set gradient(val: GradientFill);
        /**
         * 字体
         */
        get font(): string;
         ...
         */
        get align(): AlignMode;
        set align(val: AlignMode);
        /**
         * 空白边距
         */
        get margin(): Number4;
        set margin(val: Number4);
        /**
         * 背景底色
         */
        get bkColor(): string;
        set bkColor(val: string);
...
declare namespace ez {
    ...
    */
    ...
    namespace Profile {
        ...
        */
        ...
        function newEvent(type: string, args: string): IEvent;
    }
    /**
    * 使用canvas渲染
    */
    ...
    * 是否使用高清渲染
    */
    function setHighDPI(enable: boolean): void;
    /**
    * 时间加速/减速，对timer起作用
    */
    function timeShift(multiply: number): void;
    /**
    * 获得根对象
    */
    function getRoot(window?: string): UIRoot;
    /**
    * 引擎初始化
    */
...
declare namespace ez {
    ...
    module FontCache {
        ...
        function getTextCacheOrKey(font: string, fill: string, stroke: string, scale: string, text: string): string | TextCacheObject;
        function setTextCache(key: string, cache: TextCacheObject): void;
        function log(): void;
        function addTextCache(cache: TextCacheObject): void;
        function updateFontTexture(gl: WebGLRenderingContext, fontTex: RawTexture, profileData?: WGLPerFrameProfiler | CanvasPerFrameProfiler): void;
    }
}
...
declare namespace ez.ui {
    ...
    */
    ...
    /**@ignore */
    function createUIElement(name: string, parent: Container): Element;
    /** 注册UI类 */
    ...
    */
    class Element extends DataModel {
        ...
        */
         ...
         * 获取控件类的元数据
         */
        get class(): UIClassData;
        /**
        * 控件id标识。每个自定义的UI类都可以包含若干带id名字的子UI元素，可以通过find方法查找，也可以通过namedChilds属性访问
        */
        get id(): string;
        /**
        * 左边位置，set可以是number,string,Dimension类型，get时为Dimension类型，下同
        */
        ...
        */
        ...
        /**
        * 右边位置。设置右边位置属性使得控件的右边自动跟随父控件的右边对齐
        */
        right: number | string | Dimension;
        /**
        * 底边位置。设置底边位置属性使得控件的底边自动跟随父控件的底边对齐
        */
        bottom: number | string | Dimension;
        /**
        * 基于anchor点的x位置，当left和right都未设置时由x确定控件位置
        */
        ...
        */
        zIndex: number;
        /**
        * 控件创建完成事件，可以通过uiClass.prototype.onCreate来绑定事件处理函数
        */
        onCreate: () => void;
        /**
        * 父UI容器
        */
        ...
        /**
        * 获取UI元素的边界，注意：UI元素的布局计算是lazy evaluate的，在游戏逻辑中不管怎么修改布局属性，都不会立刻计算元素的边界，
    ...
    */
    class Container extends Element {
        ...
        */
        ownerBuffer: boolean;
        /**
        * 跨stage的自动合批模式，打开改选项可以将该容器下的所有子元素按照渲染状态进行重新排序，以尽可能有利于合批提高渲染性能（但也可能造成前后次序错误，谨慎使用）
        */
        batchMode: boolean;
        /**
        * 文本样式，（Label子控件会逐级向父容器请求文本样式）
        */
        textStyle: string;
        /**
        *  创建子元素
        ...
        */
        ...
        /**
        * 设置样式，样式可以为字符串，表示从控件类的样式表（styles）里寻找相应的样式，在uiml里要预先定义相应的样式表。style对象为一个JSON对象，包含一组属性值
        */
    ...
    */
    class Control extends Container implements TouchHandler {
        ...
        */
        state: string;
        /**
         * 当Control设置为hittable时，Control区域内默认都可被点中，否则将调用Control内子元素的hitTest方法
         */
        hittable: boolean;
        hitTest(x: number, y: number): boolean;
        /**
        设置状态数据表
        public setStateData(state: string, data: ControlStateData) {
            this._states[state] = data;
            if (state == this.state && data.items)
                Control.applyState(data.items);
        }
        */
        protected _setStyle(style: Dictionary<any>): void;
        /**
    ...
    */
    class ListView extends Container {
        ...
        */
        set items(source: DataCollection | any[]);
        get items(): DataCollection | any[];
        /**
        * 布局模式
        */
    ...
    */
    class Visual extends Element {
         ...
         * shader特效参数
         */
        get effectParams(): Object;
        set effectParams(v: Object);
        /**
        * 混合模式
        */
...
declare namespace ez {
    ...
    interface UIRoot extends DataModel {
        ...
        /** @ignore */
        capture(id: number, ctrl: TouchHandler): any;
        /** @ignore */
        screenToClient(x: number, y: number): Point;
        /** @ignore */
        clientToScreen(x: number, y: number): Point;
...
declare namespace ez {
    ...
    class ImageSprite extends Sprite {
        ...
        protected _data: Texture | ImageRes;
        protected _hitMask: {
            data: number[][];
            level: number;
        };
        ...
        */
        get src(): string | Texture | ImageRes;
        set src(img: string | Texture | ImageRes);
        /**
        * 设置重复填充模式，可选模式："repeat-x","repeat-y", "repeat"
        */
        get pattern(): "repeat-x" | "repeat-y" | "repeat";
        set pattern(pattern: "repeat-x" | "repeat-y" | "repeat");
        /**
...
declare namespace ez {
    ...
    class RectFillSprite extends Sprite {
         ...
         * 设置渐变填充
         */
        get gradient(): string | GradientFill;
        set gradient(g: string | GradientFill);
    }
}
declare namespace ez {
    /**
    ...
    */
    ...
    namespace internal {
        function setImageExt(ext: any): void;
    }
    /**
     * 检查浏览器对图像格式的支持
...
declare namespace ez {
    ...
    */
     ...
     * @returns frames
     */
    function toFrames(data: SeqFrameDesc): string[];
    /**
     * 序列帧动画对象
     */
    class SeqFrameSprite extends Sprite {
        ...
        private _height;
        private _autoPlay;
        private static playTicker;
        private static playings;
        static Type: string;
        getType(): string;
        private static _update;
        private get currInterval();
        protected _draw(rc: IRenderContext, opacity: number): boolean;
        private _update;
        _dispose(): void;
        ...
        */
         ...
         */
        get frames(): Texture[] | string[] | SeqFrameDesc;
        set frames(vals: Texture[] | string[] | SeqFrameDesc);
        private loadFrames;
        /**
         * 加载后自动播放
         */
...
declare namespace ez {
    ...
    */
    class Shader {
         ...
         * @param textures: unifrom表中的附加纹理参数(不包含texture0，2d shader中使用)
         */
         ...
         */
        static register(name: string, shader: Shader): void;
        /**
         * 是否有该shader
         * @param name
         */
...
declare namespace ez {
    ...
    /**
     * 舞台对象接口
     * @description 舞台是sprite的容器，舞台里可以嵌套sprite子舞台，舞台中的每个sprite继承舞台自身的变换矩阵和透明度设置
     */
    interface Stage {
        /** @ignore */
    ...
    class SubStageSprite extends Sprite implements Stage, IPreRender {
        ...
        */
        culling: boolean;
        /**
        * 获取舞台接口(已废弃，SubStage直接实现Stage接口)
        */
        get stage(): Stage;
        /**
        * 舞台宽度
...
declare namespace ez {
    ...
    */
    class RenderTexture extends Texture {
        ...
        static create(width: number, height: number, hasDepth?: boolean): RenderTexture;
    }
}
declare namespace ez {
    class Ease {
...
declare namespace ez {
    ...
    namespace internal {
        ...
        var ezmDecoder: {
            load: (url: string, format: number, size: number, event: Profile.IEvent, onResult: (r: IEZDecodeResult) => void) => void;
        };
    }
    /**
     * 加载ezm图像格式解码器
...
interface ezasmInterface {
    buffer: ArrayBuffer;
    setFloatArray(handle: Handle, array: number[]): any;
    handleToFloatArray(handle: Handle, count: number): Float32Array;
    handleToByteArray(handle: Handle, size: number): Uint8Array;
    memcpy(dest: Handle, src: Handle, size: number): any;
    poolAllocDebug(size: number, type: number): Handle;
    poolAlloc(size: number): Handle;
    poolFree(node: Handle): any;
    initStaticMemoryPage(pageSize: number): any;
    initTempStackMemory(pageSize: number): any;
    tempStackAlloc(size: number): Handle;
    saveTempStack(): any;
    restoreTempStack(): any;
    staticAlloc(size: number): Handle;
    malloc(size: number): Handle;
    free(handle: Handle): any;
    printPoolInfo(): any;
    newSpriteData(): Handle;
    buildLocalTrans(s: Handle, targetTrans: Handle): number;
    buildGlobalTrans(s: Handle, transform: Handle): any;
    cullingTest(s: Handle, left: any, top: any, right: any, bottom: any): boolean;
    ...
    setx(s: Handle, v: number): any;
    sety(s: Handle, v: number): any;
    setsx(s: Handle, v: number): any;
    setsy(s: Handle, v: number): any;
    setscale(s: Handle, v: number): any;
    setanchorX(s: Handle, v: number): any;
    setanchorY(s: Handle, v: number): any;
    setangle(s: Handle, v: number): any;
    setskew(s: Handle, v: number): any;
    setMirrorH(s: Handle, v: boolean): any;
    setMirrorV(s: Handle, v: boolean): any;
    setwidth(s: Handle, v: number): any;
    setheight(s: Handle, v: number): any;
    setVisible(s: Handle, v: boolean): any;
    setCulled(s: Handle, v: boolean): any;
    calcBound(s: Handle): Handle;
    getOwnerBuffer(s: Handle): boolean;
    setOwnerBuffer(s: Handle, v: boolean): any;
    getClip(s: Handle): boolean;
    setClip(s: Handle, v: boolean): any;
    getQuadsBuffer(): Handle;
    addQuad(quadIdx: number, flags: any): any;
    renderScaleTrans(width: any, height: any, transform: Handle): any;
    renderScaleTranslateTrans(width: any, height: any, x: any, y: any, transform: Handle): any;
    setUVIdentity(): any;
    setUV(l: any, t: any, w: any, h: any): any;
    setUVGrad(x0: any, y0: any, x1: any, y1: any, w: any, h: any, len: any): any;
    setOpacity(val: any): any;
    setFillColor(r: any, g: any, b: any): any;
    setFrameBufferSize(width: any, height: any): any;
    tempAllocMat2x3(_11: any, _12: any, _21: any, _22: any, x: any, y: any): Handle;
    mat2x3Append(m1: Handle, m2: Handle): any;
    setGlobalTransform(m: Handle): any;
    mat3x4Identity(): Mat3x4Handle;
    mat3x4Mul(m1: Handle, m2: Handle, result: Mat3x4Handle): any;
    mat3x4FromQuat(x: any, y: any, z: any, w: any, result: Mat3x4Handle): any;
    mat3x4ScaleTranslate(sx: any, sy: any, sz: any, x: any, y: any, z: any, result: Mat3x4Handle): any;
    quatLerp(q1: Handle, q2: Handle, t: number, out: Handle): any;
}
/**@ignore */
